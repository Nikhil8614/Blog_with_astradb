...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            'connection': {
                'auth_provider': PlainTextAuthProvider('khhQcKicDpjlEYztZtMHDBWE', 'P3m77zPyLfexXjlhrPeYCmtl3TcmL+G9_fZfv9Zl8s2Ik6Ker3,,fXEBqJ0_JL3k5q8CGiKOfMM-yIbDb585NuP69ocUxExwA7elIGAG,pS0cZ_YR80FmjxR.b2Kax3h'),
                'cloud': {
